...
export function renderStatsCard(stats: GitHubStats, options: CardOptions): string {
  ...
  const iconPaths = {
    ...
    commits: 'M10.5 7.75a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0zm1.43.75a4.002 4.002 0 01-7.86 0H.75a.75.75 0 110-1.5h3.32a4.001 4.001 0 017.86 0h3.32a.75.75 0 110 1.5h-3.32z',
  ...
  const drawIcon = (path: string) => options.showIcons ? `<svg x="25" viewBox="0 0 16 16" version="1.1" width="16" height="16"><path fill="${theme.iconColor}" fill-rule="evenodd" d="${path}"></path></svg>` : '';
